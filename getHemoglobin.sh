...
#
intergenic=`~/BEDTools/bin/intersectBed -v -bed -abam $bam -b $gene | wc -l | awk '{print $1/1000000}'`
#
# get counts to gene regions
#
genic=`~/BEDTools/bin/intersectBed -u -bed -abam $bam -b $gene | wc -l | awk '{print $1/1000000}'`
#
fiveUTR=`~/BEDTools/bin/intersectBed -u -bed -abam $bam -b $utr5 | wc -l | awk '{print $1/1000000}'` 
#
threeUTR=`~/BEDTools/bin/intersectBed -u -bed -abam $bam -b $utr3 | wc -l | awk '{print $1/1000000}'` 
#
exonic=`~/BEDTools/bin/intersectBed -u -bed -abam $bam -b $exon | wc -l | awk '{print $1/1000000}'` 
#
intronic=`~/BEDTools/bin/intersectBed -u -bed -abam $bam -b $intron | wc -l | awk '{print $1/1000000}'` 
#
